...
public class PopulateDatabase
{
  public static void main( String args[] )
  {
	...
	try {
		...
		//Eagles:
		db.add_QA(4, 2, "What are eagles窶� nests called?", "Eyries");
		...
		//Hyenas:
		db.add_QA(16, 6, "What does a hyena窶冱 laugh indicate?", "Social status and age");
		...
		//Giraffes:
		db.add_QA(22, 8, "What is the color of a giraffe窶冱 tongue?", "Purple");
		...
		db.add_QA(26, 9, "How large can an antelope窶冱 horns grow?", "5 feet");
		db.add_QA(27, 9, "How fast can antelope run?", "43 mph");
		
		//Rhinoceros:
		db.add_QA(28, 10, "What does the word 窶腕hinoceros窶� mean?", "Nose horn");
