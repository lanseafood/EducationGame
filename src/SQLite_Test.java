...
public class SQLite_Test
{
  public static void main( String args[] )
  {
	...
	try {
		...
		db.add_QA(1, 1, "What do lions eat?", "Whatever they want.");
		db.add_QA(2, 2, "What is this database?", "Your best friend.");
		db.add_QA(3, 1, "Why did the chicken cross the road?", "I don''t know.");
		db.add_QA(4, 2, "Why are lions cool?", "Those gnarly teeth, yo.");
		db.remove_QA(2);
